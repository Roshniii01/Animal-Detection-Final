    ...
    while cap.isOpened():
        ...
        for result in results:
            for box in result.boxes:
                ...
                if label in ['Tiger', 'Elephant','Rhino','Leopard',]:  # Add more animal classes if needed
...
# Streamlit UI
st.title("Animal Dectection in Video using YOLOv8")
